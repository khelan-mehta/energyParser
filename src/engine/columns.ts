 ...
 *  to stay schema-compatible with the original epAutomate output)
 * ============================================================ */
export type ColDef = [string, string, string, string]; // [header, key, numFmt, hexColor]

export const C_BLUE = "4472C4", C_GREEN = "70AD47", C_ORANGE = "ED7D31", C_PURPLE = "7030A0",
...
export const COLUMNS: ColDef[] = [
  ...
  ["Total Water Cost ($)", "total_water_cost", '"$"#,##0.00', C_PURPLE],
  ["Water Virtual Rate ($/kGal)", "water_rate_per_kgal", "0.000", C_PURPLE],
  ...
  ["Rate Structure", "rate_structure", "@", C_GRAY],
  ["Rate Source", "rate_source", "@", C_GRAY],
  ...
  ["Electricity Carbon Rate (kg CO2e/kBtu)", "elec_carbon_rate", "0.0000", C_GRAY],
  ["Gas Carbon Rate (kg CO2e/kBtu)", "gas_carbon_rate", "0.0000", C_GRAY],
  ["Carbon Method", "carbon_method", "@", C_GRAY],
  ["Carbon Source", "carbon_source", "@", C_GRAY],
  ["Additional Fuel Carbon Rate (kg CO2e/kBtu)", "add_fuel_carbon_rate", "0.0000", C_GRAY],
  ["District Cooling Carbon Rate (kg CO2e/kBtu)", "dc_carbon_rate", "0.0000", C_GRAY],
  ["District Heating Carbon Rate (kg CO2e/kBtu)", "dh_carbon_rate", "0.0000", C_GRAY],
  ...
  ["Above Ground West Wall Area (ft²)", "above_ground_west_wall", "#,##0", C_LIME],
...
export function round1(x: number) { return Math.round((x || 0) * 10) / 10; }
